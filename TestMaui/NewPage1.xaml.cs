...
{
    const string PageName = nameof(NewPage1);
    public NewPage1()
    {
        InitializeComponent();
    ...
    private async void Button_Clicked_1_1(object sender, EventArgs e)
    {
        Console.WriteLine("Goto NewPage 1-1");
        await Shell.Current.GoToAsync(nameof(NewPage1_1));
    }

    private async void Button_Clicked_1_2(object sender, EventArgs e)
    {
        Console.WriteLine("Goto NewPage 1-2");
        await Shell.Current.GoToAsync(nameof(NewPage1_2));
    }
