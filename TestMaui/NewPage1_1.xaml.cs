...
public partial class NewPage1_1 : ContentPage
{
    const string PageName = nameof(NewPage1_1);
    public NewPage1_1()
    {
        InitializeComponent();
    ...
    {
        Console.WriteLine("Goto NewPage 1");

        //This error: can not goto root element using relative
    ...
    {
        Console.WriteLine("Goto //NewPage1/NewPage1_1");
